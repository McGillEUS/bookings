...
echo '<a href="http://www.mcgilleus.ca/"><img src="euslogo.png" style="padding:5px; border:none; width:200px; height:147px" alt="McGill EUS" /></a>';
...
// EUS IT Director - removed November 1, 2017. Not needed.
// show_colour_key();
...
echo '<p style="text-align: center">The booking system is often modified. Contact <a href="mailto:it.director@mcgilleus.ca">it.director@mcgilleus.ca</a> with any issues.</p>';
